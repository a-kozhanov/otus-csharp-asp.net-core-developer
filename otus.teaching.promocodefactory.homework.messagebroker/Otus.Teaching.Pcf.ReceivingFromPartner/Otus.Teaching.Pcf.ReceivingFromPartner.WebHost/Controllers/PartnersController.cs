...
namespace Otus.Teaching.Pcf.ReceivingFromPartner.WebHost.Controllers
{
        ...
        : ControllerBase
    {
        ...
        private readonly GivingPromoCodeToCustomerNotifier _givingPromoCodeToCustomerNotifier;
        private readonly AdministrationNotifier _administrationNotifier;

        public PartnersController(IRepository<Partner> partnersRepository,
            IRepository<Preference> preferencesRepository,
            INotificationGateway notificationGateway,
            GivingPromoCodeToCustomerNotifier givingPromoCodeToCustomerNotifier,
            AdministrationNotifier administrationNotifier)
        {
            _partnersRepository = partnersRepository;
            _preferencesRepository = preferencesRepository;
            _notificationGateway = notificationGateway;
            _givingPromoCodeToCustomerNotifier = givingPromoCodeToCustomerNotifier;
            _administrationNotifier = administrationNotifier;
        }
